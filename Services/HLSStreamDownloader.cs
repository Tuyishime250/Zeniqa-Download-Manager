...
{
    public class HLSStreamDownloader : IDownloader
    {
        private readonly HttpClient _httpClient;

        public HLSStreamDownloader()
        {
        ...
        public async Task DownloadAsync(DownloadJob job, CancellationToken cancellationToken)
        {
            try
            {
                ...
                {
                    throw new System.IO.InvalidDataException("No segment URLs available for HLS download");
                }
            ...
            {
                throw new System.IO.IOException($"Failed to download HLS stream: {ex.Message}");
            }
        }
